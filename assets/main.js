				...
				sections = {
					'itsupport': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-CDQ7S2TVFE', { 'page_path': '/#itsupport' });
								},
							],
						},
					},
					'troubleshooting': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-CDQ7S2TVFE', { 'page_path': '/#troubleshooting' });
								},
							],
						},
					},
					'resume': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-CDQ7S2TVFE', { 'page_path': '/#resume' });
								},
							],
						},
					},
					'contact-me': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-CDQ7S2TVFE', { 'page_path': '/#contact-me' });
								},
							],
						},
					},
					'home': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-CDQ7S2TVFE', { 'page_path': '/' });
								},
							],
						},
					},
